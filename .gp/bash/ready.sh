...
git_msg() {
  pink "If you are developing/extending gp-react-on-rails-starter:"
  orange "  Don't forget to revert the autogenerated commit!"
  green "  run:$c_blue git reset HEAD~$c_end"
  pink "Otherwise for all other projects, before you make any changes:"
  orange "  Push all autogenerated changes to the remote repository."
  green "  run:$c_blue git new \"initial scaffolding\"$c_end"
}

enjoy() {
  green "Enjoy your coding experience 👩‍💻👨‍💻" 
}

preview() {
  start_spinner "$c_green""Opening preview when server is ready$c_end"
  gp sync-await server-ready > /dev/null 2>&1  && stop_spinner 0 && enjoy
